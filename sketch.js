...
let innerScaleHoverFactor;

let palette= [ '#0A8E71', '#27CEAC', '#99e9c2', '#ffffff', '#7BACE4', '#5249C8', '#3E1B79'];
...
function draw() {
  ...
  for (let h of hexagons) {
    ...
    if(pointInHexagon(mouseX, mouseY, h.x, h.y, hexRadius)) {h.targetScale = baseScale * innerScaleHoverFactor;}
    else {
